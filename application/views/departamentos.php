                                        ...
                                        <div class="card zoom card_prod" style="border-radius: 7px;">
                                            <div class="card-body" style="padding: 2px; border-bottom: 7px solid #EC9706; border-radius: 7px;">
                                                <div class="text-center divImagemServico">
                                                    <img class="imagem_prod" src="<?php echo base_url($p['produto_imagem']) ?>" alt="">
                                                </div>
                                                <?php if(isset($p['produto_porcentagem'])){ ?>
                                                    <p class="servico-desconto"><i class="fa fa-arrow-down" aria-hidden="true"></i> <?php $p['produto_porcentagem'] ?></p>
                                                <?php } ?>
                                                ...
                                                <!--<p class="servico-titulo"><?php //echo ucfirst(mb_strtolower($p['produto_nome'])) ?></p>-->
                                                
                                                <!--<p class="text-center prod-departamento"><span style="font-size: 13px;"><b style="color: var(--base-color);"><?php //echo ucfirst(mb_strtolower($aux_nome[0])) ?></b></span></p>-->
                                                <p class="text-center servico-titulo px-4" style="margin-top: 7%; font-weight: 600; color: var(--base-color);"><?php echo ucfirst(mb_strtolower($p['produto_nome'])) ?></p>
                                                    
                                                <div class="row">
                                                    <?php if($p['valor_desconto']){ ?>
                                                        <div class="col-md-12 col-12 text-center">
                                                            <strike>R$ <?php echo number_format($p['produto_valor'],2,',','.') ?></strike><br><!--<p class="prod-preco" style="color: #444; line-height: 15px; margin: 0!important; padding: 0!important;font-size: 12px; text-decoration: line-through;">R$ <?php echo number_format($p['produto_valor'],2,',','.') ?></p>-->
                                                            <p class="prod-preco text-center btn btn-secondary"><b style="font-size: 20px; font-weight: bold;line-height: 30px;">R$ <?php echo number_format($p['valor_desconto'], 2,',','.') ?></b></p>
                                                            <?php if($p['produto_parcelamento'] == 0){ ?>
                                                                <p class="text-center prod-departamento" style="margin-top: -7%;"><span style="font-size: 13px; color: #828282;"><?= $p['produto_qtd_parcela'] ?></span></p>
                                                            <?php } ?>
                                                        </div>
                                                    <?php } else { ?>
                                                        <div class="col-12 col-md-12 text-center">
                                                            <strike hidden>R$ 999,99</strike><br><!--<strike hidden class="prod-preco" style="color: #444; line-height: 15px; margin: 0!important; padding: 0!important;font-size: 12px; text-decoration: line-through;">R$</strike>-->
                                                            <p class="prod-preco text-center btn btn-secondary"><b style="font-size: 20px; font-weight: bold;line-height: 30px;">R$ <?php echo number_format($p['produto_valor'], 2,',','.') ?></b></p>
                                                            <?php if($p['produto_parcelamento'] == 0){ ?>
                                                                <p class="text-center prod-departamento" style="margin-top: -7%;"><span style="font-size: 13px; color: #828282;"><?= $p['produto_qtd_parcela'] ?></span></p>
                                                            <?php } ?>
                                                        </div>
                        ...
                        <?php if(is_array($servicos)){foreach($servicos as $p){?>
                            <div id="cards-prod" class="col-lg-3 col-md-4 col-6 form-group servicos-div">
                                ...
                                <div class="card zoom card_prod" style="border-radius: 7px;">
                                    <div class="card-body" style="padding: 2px; border-bottom: 7px solid #EC9706; border-radius: 7px;">
                                        <div class="text-center divImagemServico">
                                            <!-- style="object-fit: cover;"--><img class="imagem_prod mx-auto" src="<?php echo base_url($p['produto_imagem']) ?>" alt="">
                                        </div>
                                        <?php if(isset($p['produto_porcentagem'])){ ?>
                                            <p class="servico-desconto"><i class="fa fa-arrow-down" aria-hidden="true"></i> <?php $p['produto_porcentagem'] ?></p>
                                        <?php } ?>
                                        ...
                                        <div class="row">
                                            <?php if(($p['valor_desconto'])){ ?>
                                                <div class="col-md-12 col-12 text-center">
                                                    ...
                                                    <p class="prod-preco text-center btn btn-secondary" style="font-size: 20px; line-height: 19px;"><b>R$ <?php echo number_format($p['valor_desconto'], 2,',','.') ?></b></p>
                                                    <p class="text-center prod-departamento" style="margin-top: -7%;"><span style="font-size: 13px; color: #828282;"><?= $p['produto_qtd_parcela'] ?></span></p>
                                                    <?php if($p['produto_parcelamento'] == 0){ ?>
                                                        <p class="text-center prod-departamento" style="margin-top: -7%;"><span style="font-size: 13px; color: #828282;"><?= $p['produto_qtd_parcela'] ?></span></p>
                                                    <?php } ?>
                                            ...
                                            <?php } else { ?>
                                                <div class="col-12 col-md-12 text-center">
                                                    <p class="prod-preco text-center btn btn-secondary btn-noPromo" style="margin-top: 5%;"><b style="font-size: 20px; font-weight: bold;line-height: 19px;">R$ <?php echo number_format($p['produto_valor'], 2,',','.') ?></b></p>
                                                    <p class="text-center prod-departamento" style="margin-top: -7%;"><span style="font-size: 13px; color: #828282;"><?= $p['produto_qtd_parcela'] ?></span></p>
                                                    <?php if($p['produto_parcelamento'] == 0){ ?>
                                                        <p class="text-center prod-departamento" style="margin-top: -7%;"><span style="font-size: 13px; color: #828282;"><?= $p['produto_qtd_parcela'] ?></span></p>
                                                    <?php } ?>
