        ...
        <div class="c-card">
            <div class="c-card-header">
                <div class="col-md-6 text-left">
                    <h2 style="color: #4da751; margin: 4% 5% 2% 1%;"><b>EDIÇÃO PRODUTO</b></h2>
                </div>
            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div id="dados">
                                    ...
                                    <div class="row" style="margin-top: 2%">
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label><b>Subtítulo do Produto:</b></label>
                                            <input type="text" id="modelo" name="modelo" class="form-control" placeholder="Subtítulo do Produto" value="<?php echo $produto['produto_subtitulo'] ?>" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input type="text" id="fabricante" name="fabricante" class="form-control" placeholder="Fabricante" value="<?= $produto['produto_fabricante'] ?>">
                                        </div>
                                        <div class="col-md-2 form-group">
                                            <label><b>Habilitado:</b></label><br>
                                            <input type="radio" id="habilitado_1" name="habilitado" value="1" style="display: inline" <?= !($produto['produto_habilitado'] == 1) ?'': 'checked'  ?>>
                                            &nbsp;<span><b>Sim</b></span>
                                            &nbsp;&nbsp;&nbsp;
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="text" id="quantidade" name="quantidade" class="form-control number" placeholder="0" value="<?php echo $produto['produto_quantidade'] ?>" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 form-group">
                                            ...
                                            <select id="medida" name="medida" class="js-example-basic-multiple" style="width: 100%!important">
                                                <option value="m" <?= $produto['und_comprimento'] == 'oz' ? 'selected' : '' ?>>Metro</option>
                                                <option value="cm" <?= $produto['und_comprimento'] == 'oz' ? 'selected' : '' ?>>Centímetro</option>
                                                <option value="mm" <?= $produto['und_comprimento'] == 'oz' ? 'selected' : '' ?>>Milímetro</option>
                                                <option value='"' <?= $produto['und_comprimento'] == 'oz' ? 'selected' : '' ?>>Polegadas</option>
                                            </select>
                                        </div>
                                        <div class="col-md-2 form-group">
                                            <label><b>Comprimento:</b></label>
                                            <input type="text" id="comprimento" name="comprimento" class="form-control number" placeholder="Comprimento" value="<?php echo $produto['comprimento'] ?>" >
                                        </div>
                                        <div class="col-md-2 form-group">
                                            <label><b>Largura:</b></label>
                                            <input type="text" id="largura" name="largura" class="form-control number" placeholder="Largura" value="<?php echo $produto['largura'] ?>" >
                                        </div>
                                        <div class="col-md-2 form-group">
                                            <label><b>Altura:</b></label>
                                            <input type="text" id="altura" name="altura" class="form-control number" placeholder="Altura" value="<?php echo $produto['altura'] ?>" >
                                        </div>
                                        <div class="col-md-2 form-group">
                                            <label><b>Unidade de Peso:</b></label>
                                            <select id="un_peso" name="un_peso" class="js-example-basic-multiple" style="width: 100%!important">
                                                <option value="kg" <?= $produto['und_peso'] == 'kg' ? 'selected' : '' ?>>Quilograma</option>
                                                <option value="g" <?= $produto['und_peso'] == 'g' ? 'selected' : '' ?>>Grama</option>
                                                <option value="mg" <?= $produto['und_peso'] == 'mg' ? 'selected' : '' ?>>Miligrama</option>
                                                <option value="lb" <?= $produto['und_peso'] == 'lb' ? 'selected' : '' ?>>Libra</option>
                                                <option value="oz" <?= $produto['und_peso'] == 'oz' ? 'selected' : '' ?>>Onça</option>
                                            </select>
                                        </div>
                                        <div class="col-md-2 form-group">
                                            <label><b>Peso:</b></label>
                                            <input type="text" id="peso" name="peso" class="form-control" placeholder="Peso" value="<?php echo $produto['peso'] ?>" >
                                        </div>
                                    </div>
                                            ...
                                            <div id="principal">
                                                <div class="row" style="margin-top: 2%">
                                                    <div class="col-md-6 form-group" style="text-align:center; position: relative; left: 300px;">
                                                        ...
                                                        <img style="width: 380px; height: 300px" src="<?php echo base_url('imagens/produtos/' . $produto['produto_id'] . '.jpg') ?>">
                                        ...
                                        <div id="opcionais" style="display: none;">
                                            <div class="row" style="margin-top: 2%; text-align:center;">
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <?php if ($produto['produto_imagem1'] == null || $produto['produto_imagem1'] == ""){ ?>
                                                    ...
                                                    <?php }else{ ?>
                                                        <img style="width: 380px; height: 300px" src="<?php echo base_url($produto['produto_imagem1']) ?>">
                                                ...
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <?php if ($produto['produto_imagem2'] == null || $produto['produto_imagem2'] == ""){ ?>
                                                    ...
                                                    <?php }else{ ?>
                                                        <img style="width: 380px; height: 300px" src="<?php echo base_url($produto['produto_imagem2']) ?>">
                                            ...
                                            <div class="row" style="margin-top: 2%; text-align:center; padding-left: 303px">
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <?php }else{ ?>
                                                        <img style="width: 380px; height: 300px" src="<?php echo base_url($produto['produto_imagens_opcional4']) ?>">
                                                ...
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <?php }else{ ?>
                                                        <img style="width: 380px; height: 300px" src="<?php echo base_url($produto['produto_imagens_opcional5']) ?>">
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <div class="col-md-12 text-right">
                                            <button type="submit" id="submitbtn" class="btn btn-primary">Atualizar</button>
                                            &nbsp;&nbsp;
...
<script type="application/javascript"> 
    $(document).ready(function(){
        ...
        <?php if($produto['produto_descontoAtivo'] != null) { ?>
            $('#desconto_ativo').val(<?php echo $produto['produto_descontoAtivo'] ?>).change();
        <?php } ?>
       ...
       <?php if($produto['produto_cupom_ativo'] != null) { ?>
        ...
        <?php foreach($aux as $a){ ?>
            $("#tamanhos option[value='" + '<?php echo $a ?>' + "']").prop("selected", true);
        <?php } ?>

        <?php $aux = explode('¬', $produto['produto_cores']); ?>
        <?php foreach($aux as $a){ ?>
            $("#cores option[value='" + '<?php echo $a ?>' + "']").prop("selected", true);
        <?php } ?>
