            ...
            <div class="c-card-header">
                <div class="row">
                    <div class="col-md-6 text-left">
                        <h2 style="color: #1b9045;"><b>VISUALIZAÇÃO PRODUTO</b></h2>
                    </div>
                    <div class="col-md-6">
                                ...
                                <div id="dados">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input type="text" id="codigo" name="codigo" class="form-control" placeholder="Código do Produto" value="<?php echo $produto['produto_codigo'] ?>"  readonly>
                                        </div>
                                        <div class="col-md-6 form-group">
                                ...
                                <div id="opcoes" style="display: none">
                                    ...
                                    <div class="row" style="margin-top: 2%">
                                        <div class="col-md-6 form-group">
                                            ...
                                            <div class="col-md-12 form-group">
                                                <select id="tamanhos" name="tamanhos[]" multiple class="js-example-basic-multiple" style="width: 100%!important;" disabled>
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <div class="col-md-12 form-group">
                                                <select id="cores" name="cores[]" multiple class="js-example-basic-multiple" style="width: 100%!important;" disabled>
