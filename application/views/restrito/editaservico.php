                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="dados" role="tabpanel" aria-labelledby="dados-tab">
                                ...
                                <div class="row" style="margin-top: 2%">
                                    <div class="col-md-3 form-group">
                                        ...
                                        <input type="text" id="codigo" name="codigo" class="form-control" placeholder="Digite o código do serviço" value="<?php echo $servico['produto_codigo'] ?>" <?php if($func == "edita" || $func == "cadastro"){ echo "required";}else{ echo "readonly";}?>>
                                    </div>
                                    <div class="col-md-5 form-group">
                                        <label><b>Título:</b></label>
                                        <input type="text" id="nome" name="nome" class="form-control" placeholder="Digite o título do serviço"  value="<?php echo $servico['produto_nome'] ?>" <?php if($func == "edita" || $func == "cadastro"){ echo "required";}else{ echo "readonly";}?>>
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label><b>Sub Título:</b></label>
                                        <input type="text" id="subtitulo" name="subtitulo" class="form-control" placeholder="Digite o sub título do serviço"  value="<?php echo $servico['produto_subtitulo'] ?>" <?php if($func == "edita" || $func == "cadastro"){ echo "required";}else{ echo "readonly";}?>>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3 form-group">
                                        <label><b>Valor:</b></label>
                                        <input type="text" id="valor" name="valor" class="valor form-control" placeholder="Digite o valor do serviço" value="<?php echo $servico['produto_valor'] ?>" <?php if($func == "edita" || $func == "cadastro"){ echo "required";}else{ echo "readonly";}?>>
                                    </div>
                                    <div class="col-md-2 form-group">
                                        <label><b>Possui parcelamento: </b></label><br>
                                        <input <?php if($servico['produto_parcelamento'] == 0){echo "checked";}?> onclick="Parcelamento(0)" type="radio" name="parcelamento" value="0" style="display: inline;height: 20px;width: 20px;">
                                        &nbsp;<span><b>Sim</b></span>
                                        &nbsp;&nbsp;&nbsp;
                                        <input <?php if($servico['produto_parcelamento'] == 1){echo "checked";}?> onclick="Parcelamento(1)" type="radio" name="parcelamento" value="1" style="display: inline;height: 20px;width: 20px;">
                                        &nbsp;<span><b>Não</b></span>
                                    </div>
                                    <div id="parcelamento_div" class="col-md-3 form-group" style="content-visibility:hidden;">
                                        <label><b>Parcelamento:</b></label>
                                        <input type="text" id="parcela" name="parcela" class="form-control" style="width: 60%;" value="<?php echo $servico['produto_qtd_parcela'] ?>">
                                    </div>
                                    <!--<div class="col-md-2 form-group">-->
                                    ...
                                    <div class="col-md-2 form-group">
                                        ...
                                        <select id="qualidade" name="qualidade" class="js-example-basic-multiple" style="width: 100%!important" >
                                            ...
                                            <option <?php if($servico['produto_qualidade'] == 1){ echo 'selected'; }?> value="1"> Ouro </option>
                                            <option <?php if($servico['produto_qualidade'] == 2){ echo 'selected'; }?> value="2"> Prata </option>
                                            <option <?php if($servico['produto_qualidade'] == 3){ echo 'selected'; }?> value="3"> Bronze </option>
                                        </select>
                                    </div>
                                    <!--<div class="col-md-2 form-group">-->
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="text" id="quantidade" name="minimo" class="form-control number" value="<?php echo $produto['produto_estoque_minimo'] ?>" placeholder="0" required>
                                        </div>
                                        <div class="col-md-2 form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-12 form-group">
                                        ...
                                        <textarea id="resumo" name="resumo" class="form-control" placeholder="Digite o breve resumo sobre o produto" <?php if($func == "edita" || $func == "cadastro"){ echo "required";}else{ echo "readonly";}?>><?php echo $servico['produto_resumo'] ?></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="promocoes" role="tabpanel" aria-labelledby="promocoes-tab">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 form-group">
                                        <label><b>Data inicial:</b></label>
                                        <input type="date" id="dataInicialCupom" name="dataInicialCupom" class="form-control" placeholder="Data inicial" value="<?php echo $servico['produto_dataInicial_cupom'] ?>">
                                    </div>
                                    <div class="col-md-3 form-group">
                                        <label><b>Data final:</b></label>
                                        <input type="date" id="dataFinalCupom" name="dataFinalCupom" class="form-control" placeholder="Data final" value="<?php echo $servico['produto_dataFinal_cupom'] ?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 form-group">
...
<script>
    ...
    $(document).ready(function(){
      Parcelamento(<?php echo $servico['produto_parcelamento']?>);
    });
