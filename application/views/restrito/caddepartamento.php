        ...
        <div class="c-card">
            <div class="c-card-header">
                <div class="col-md-6 text-left">
                    <h2 style="color: #4da751; margin: 4% 5% 2% 1%;"><b>ADICIONAR DEPARTAMENTO</b></h2>
                </div>
            </div>
            <form id="form" action="<?php echo base_url('f0231933a4d275da05d89ed935d5d9f3');?>" method="post" enctype="multipart/form-data">
                ...
                <div class="tab-pane active in" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <div class="row" style="background-color: white; margin-left: 5px; margin-right: 5px">
                        <div class="col-md-12">
                            ...
                            <!--    <li class="active" id="li_dados" onclick="dados()">Geral</li>-->
                            <!--    <li id="li_detalhes" onclick="detalhes()">Dados</li>-->
                            <!--</ul>-->
                            ...
                            <div id="dados" style="padding: 10px">
                                    ...
                                    <div class="col-md-12 form-group">
                                        ...
                                        <select style="width: 100%" class="js-example-basic-multiple" name="principal" id="principal">
                                            ...
                                            <?php foreach($departamentos as $row){
                                                echo "<option value='".$row['departamento_id']."'>".$row['departamento_nome']."</option>";
                                            } ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 form-group" style="margin-top: 30px;">
                                        ...
                                        <input type="checkbox" name="onmenu" id="onmenu">
                                    </div>
                                    <!--<div class="col-md-3 form-group" style="margin-top: 30px;">-->
                                    <!--    <label><b>Exibir no header</b></label>-->
                                    <!--    <input type="checkbox" name="onheader" id="onheader">-->
                                    <!--</div>-->
                                </div>
                                ...
                                <!--        <input type="text" id="metatitulo" name="metatitulo" class="form-control"  required>-->
                                <!--    </div>-->
                                <!--</div>-->
                                ...
                                <!--        <textarea class="form-control" id="metadescricao" name="metadescricao"></textarea>-->
                                <!--    </div>-->
                                <!--</div>-->
                                ...
                                <!--        <textarea class="form-control" id="metapalavra" name="metapalavra"></textarea>-->
                                <!--    </div>-->
                                <!--</div>-->
                            </div>
