            ...
            <div class="c-card-body">
                <div class="table-responsive" style="width: 100%">
                    ...
                    <tbody>
			            ...
			            <tr class="tr-check">
			                <td><?php echo $s['produto_codigo'] ?></td>
			                <td><?php echo ucfirst(strtolower($s['produto_nome'])); ?></td>
			                <td>R$<?php echo number_format($s['produto_valor'],2,',','.') ?></td>
			                <td class="text-center"><?php if($s['produto_habilitado'] == 1) { echo 'Habilitado'; } else { echo 'Desabilitado';} ?></td>
			                <td class="text-center" style="color: #4da751;">
			                    <a style="color: #4da751;" href="<?php echo base_url('admin/adminservicos/verServico/' . $s['produto_id']) ?>"><i style="font-size: 25px" class="fa fa-eye" aria-hidden="true"></i></a>
			                    <a style="color: #4da751;" href="<?php echo base_url('admin/adminservicos/edita/' . $s['produto_id']) ?>"><i style="padding-left: 12px; font-size: 25px" class="fa fa-pencil" aria-hidden="true"></i></a>
			                    <i onclick="excluirproduto(<?php echo $s['produto_id'] ?>)" data-toggle="modal" data-target="#statusModal" style="padding-left: 12px; font-size: 25px" class="fa fa-trash" aria-hidden="true"></i>
			                    <!--<?php if($s['produto_livre'] == 0){?>-->
			                    <!--<a style="color: #4da751;" target="_blank" href="<?php echo base_url("e9b8ed111f1726b0583dcfec2dbe2ea1/".$s['produto_id']); ?>"><i style="padding-left: 12px; font-size: 25px" class="fa fa-link" aria-hidden="true"></i></a>-->
			                    <!--<?php }?>-->
			                </td>
			            </tr>
			            <?php } ?>
