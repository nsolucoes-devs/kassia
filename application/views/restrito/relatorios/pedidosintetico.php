        ...
        <section id="container" style="position: relative; margin-top: 5%; margin-right: 1%; margin-left: 1%; width: 98%">
            ...
            <div class="row">
                <div class="col-md-12" style="text-align: right">
                    <button id="btn" type="button" class="btn btn-primary" style="border-color: var(--base-color) !important; color: white; background-color: var(--base-color) !important; right: 0; float: right; margin-right: 20px; margin-bottom: 20px" onclick="pdf()">Relatório PDF</button>
                </div>
            </div>
            <div class="row">
